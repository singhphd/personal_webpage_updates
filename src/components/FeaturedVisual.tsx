...
export const FeaturedVisual = () => {
    return (
        <div className="relative h-full w-full min-h-[250px] flex flex-col justify-end overflow-hidden rounded-xl bg-neutral-900 group">
            ...
            <div className="relative z-10 p-6">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">
                    Tracking Cloud Top Generating Cells
                </h3>
                <p className="text-sm text-gray-300 max-w-2xl mb-4">
                    Constructing a global climatology of generating cells using multi-year ground-based radar data to improve precipitation forecasts in climate models.
                </p>
                <Link 
                    href="/research#ctgc" 
